...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        try:
            ...
            # ============================================================
            # CONFIGURAÇÃO DE CORS (CORREÇÃO PARA ACESSO DO FRONTEND)
            # ============================================================
            # Liberamos explicitamente para evitar o erro de conexão no navegador
            app.add_middleware(
                CORSMiddleware,
                allow_origins=["*"],
...
def read_root():
    return {"message": "Central Transfers API is running", "status": "online"}
